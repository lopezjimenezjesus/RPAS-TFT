...
\newcolumntype{S}{>{\raggedleft\arraybackslash}p{3cm}}
\newcolumntype{T}{>{\raggedleft\arraybackslash}p{4cm}}
...
\affil{\textsuperscript{a}Taylor \& Francis, 4 Park Square, Milton Park, Abingdon, UK; \textsuperscript{b}Institut f\"{u}r Informatik, Albert-Ludwigs-Universidad\"{a}t, Seville, Spain}
}
% \author{\Large Jesús Jiménez López\vspace{0.05in} \newline\normalsize\emph{University}  \and \Large Margarita Mulero-Pázmány\vspace{0.05in} \newline\normalsize\emph{University} }
\title{Contribution of RPAS in research and conservation in protected areas:
present and future}
...
understanding of ecological processes. In the last few decades, we have
...
anti-poaching strategies. It remains to be seen how well RPAS fit into
conservation tasks in protected areas, since there are technical,
...
improvement of reliability and sensor characteristics, the parallel
design of computer intensive statistical methods and a greater concern
for animal welfare, there are high expectations in the research
community and RPAS applications in protected areas is increasingly
justified.}
  \rightskip5em
  \par
  \endgroup
