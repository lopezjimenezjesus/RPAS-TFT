...
$if(anonymous)$\hfill $else$$for(author)$\textbf{\authorfont $author.name$} \hskip 15pt \vskip 8.5pt  \emph{\small $author.affiliation$}  $sep$ \par $endfor$ $endif$
...
\vskip 8.5pt \noindent \emph{Palabras claves}: $keywords$ \par
